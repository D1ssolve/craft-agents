...
Use `/Users/diss0x/dev/craft-agents/.opencode-plugin/agents/system-architect/references/adr-template.md` and `/Users/diss0x/dev/craft-agents/.opencode-plugin/agents/system-architect/references/tasks-template.md`. Canonical architecture files are decision and execution interfaces, not a discovery transcript.
