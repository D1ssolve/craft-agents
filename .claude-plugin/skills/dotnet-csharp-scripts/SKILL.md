---
description: "Run single-file C# programs as scripts for quick experimentation, prototyping, and concept testing. Use when the user wants to write and execute a small disposable C# program without creating a full project or modifying an existing solution."
name: csharp-scripts
---
...
- [ ] The chosen script flow runs or compiles without errors (an explicit `dotnet build <file>.cs` check is optional fallback, not required)
