...
actions:
  - body: >
      ...
      Use the skill tool to load the "caveman" skill IMMEDIATELY — this is not
      optional. Call the skill tool with name="caveman" right now, before
      responding to any user message. The caveman skill contains the always-on
      communication rules that must be applied to every response.


      Do NOT load the caveman skill again after this first load — it persists
    ...
    runtime: opencode
    type: runtime_code
description: "Imported OpenCode plugin: caveman"
enabled: true
events: []
name: caveman
